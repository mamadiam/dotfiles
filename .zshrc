...
HISTFILE=~/.zsh_history       # File to save your command history
# source /path/to/zsh-syntax-highlighting/zsh-syntax-highlighting.zshHISTSIZE=10000                # Number of commands to remember in history
